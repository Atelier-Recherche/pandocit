export const locators =
  // eslint-disable-next-line no-irregular-whitespace -- regex de repérage des locuteurs de localisation multilingues ; contient intentionnellement des caractères non-ASCII/espaces de nombreuses langues
